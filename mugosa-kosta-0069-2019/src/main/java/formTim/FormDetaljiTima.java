...
/**
 * Forma za prikazivanje detalja nekog tima iz tabele za pretragu. Isto tako omogucava i brisanje
 * ili izmjenu informacija o timu.
 * 
 * @author Kosta
 */
public class FormDetaljiTima extends javax.swing.JDialog {
	/**
	 * Tim ciji se detalji prikazuju.
	 */
    private Tim t;
    /**
     ...
     * @param t konkretan tim ciji se detalji prikazuju
     */
    ...
    /**
     * Dugme koje sluzi za brisanje tima.
     * Klikom na dugme otvara se dijalog koji pita da li smo sigurni da zelimo da obrisemo tim
     * i na osnovu odgovora radi sledece: NE - vraca nas na nazad na formu, DA - provjerava da li
     * je tim igrao neke utakmice na turniru, ako jeste baca exception, ako nije brise tim, refreshuje tabelu
     * i puni ostale timove i javlja o uspjesnosti brisanja tima
     * 
     * @param evt event listener
     */
    ...
    /**
     * Dugme za izmjenu izabranog tima. Korisnik upisuje u polja informacije o timu,
     * preduslov je da sva polja moraju biti popunjena, postavljaju se nove vrijednosti
     * refreshuje tabela, puni se ovako izmijenjenim timovima i javlja poruku o uspjesnoti
     * izvrsavanja.
     * 
     * @param evt event listener
     */
...
//            Logger.getLogger(FormDetaljiTima.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox<Fudbaler> cmbFudbaler;
